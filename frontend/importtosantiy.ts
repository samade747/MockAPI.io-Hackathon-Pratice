...
// import { SanityProduct, SanityShipment, SanityTracking, SanitySale } from '../frontend';
...
interface MockAPIData {
  ...
  async function importToSanity() {
    try {
      ...
      const mockApiUrl = 'https://677d3ee94496848554c9b585.mockapi.io/api/'; // Replace with your MockAPI URL
